...
const Membros = () => {
  return (
    <main className="font-mono flex flex-col items-center bg-red-800 text-white">
      <h1 className="text-3xl font-bold mt-10">Membros</h1>
      <ul className="grid grid-cols-1 w-4/5 md:grid-cols-3 place-items-center">
        {membros.map((membro) => (
          <li className="py-16 text-center p-3 my-2 hover:border-2 hover:border-red-300 hover:rounded-3xl">
            <a href={membro.urlDescription} target="_blank">
