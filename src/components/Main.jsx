...
const Main = () => {
  return (
    <section className="principal">
      <h2 className="principal-title">Akatsuki</h2>

      <img className="manto" src="img/manto.jpeg" alt="Manto da akatsuki" />
      ...
      <p>
        ...
        para alguns países ninja. Além disso, eles possuíam um objetivo próprio,
        que é revelado mais adiante, de{' '}
        <em>
